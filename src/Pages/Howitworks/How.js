        ...
        <div className={Hcss.Hbody}>
            <div className='Head'>
                    <div className={Hcss.sHead}>
                        ...
                        <ul style={{color:"white", marginTop:"6px"}}>We provide a platform to make this communication possible</ul>
                    </div>
            ...
            <div className={Hcss.fmiddle}>
                    <div className={Hcss.ffmiddle}>
                        ...
                        <div className={Hcss.ziddle}>
                            <div className={Hcss.R3}>
                                ...
                                <p style={{marginTop:"15px",fontSize:"small",color:"#f4af1b"}}>
                                    ...
                                    Want to plan Ahead?
                                    We've got you covered. Rushour how make it possible for anyone at all to request for traffic information
                                    at the comfort of their home. We make it possible for you to plan yor journey ahead of time.
                                    No matter what you need to know, we are here to sought you out.
                                </p>
                            </div>
                        ...
                        <div className={Hcss.xiddle}>
                            <div className= {Hcss.R3}>
                                ...
                                Feel like making a difference?, We record all traffics sugested on this platform as and when they come. on the click of a Button
                    ...
                    <div className={Hcss.sfmiddle}>
                             <div className={Hcss.L}>
                                ...
                                We beleive road traffic begins and ends with us. We have the power not to to just reduce 
                                the traffic in town but to prevent it from happening at all.
                                From street closure to event specific traffic controls, our two way data exchange makes
