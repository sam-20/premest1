    ...
    return (
        ...
        <div>
            <div className = {DashCss.sug}>
                ...
                <Select text2="Traffic" text1="Road Block" name="traffic type" text3="Accident" text4="Police Inspection" className={DashCss.select} onChange={updateValues} />
                ...
                <Button className={DashCss.btn} text="Suggest" height="35px" width="300px" onClick={Getvalues}/>
            </div>
        </div>
    )
}
